...
- For ambiguous, architectural, risky, or multi-file development work, use the `littlepowers:using-littlepowers` skill before implementation.
- Shape that work through brainstorm → spec → design → plan unless I explicitly skip or combine a phase.
