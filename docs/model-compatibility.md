...
GPT-5.6 guidance also recommends lean prompts, single-stated rules, outcome-focused autonomy boundaries, and representative evaluation. v0.3 responds by:
...
The prerelease does not claim level 4 for Fable 5 or Opus 4.8. Add dated results rather than turning a model snapshot into a permanent guarantee.
